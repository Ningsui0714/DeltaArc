...
export function createProductionSpecialistOutput(
  ...
  return {
    perspective: {
      ...
      verdict: '生产风险不是功能少，而是小团队把本该一次验证的核心内容价值拆散到过多系统里。',
      opportunity: '如果把原型边界压得足够狠，生产约束反而会逼出更清晰的验证结论。',
      concern: primaryConcern,
      leverage: '围绕单次内容闭环收缩范围，让每个系统都直接服务于验证目标。',
      evidenceRefs,
    },
    blindSpots: normalizeBlindSpots([
      {
        area: '原型边界',
        whyItMatters: '边界不清时，团队会以为自己在做验证，实际在堆半成品。',
